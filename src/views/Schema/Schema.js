        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              ...
              <p className={classes.cardCategoryWhite}>Complete your Schema</p>
            </CardHeader>
            <CardBody>
              <GridContainer>
                <GridItem xs={12} sm={12} md={12}>
                        ...
                        {this.state.submitButtonAppear ? (
                          <Button
                            onClick={() => {
                              ...
                              for (
                                let i = 0;
                                i < openScraper.definition.length;
                                i++
                              ) {
                                let definition = {
                                  ...openScraper.definition[i],
                                };
                                definition.properties = this.test(
                              ...
                              for (
                                ...
                                for (let j = 0; j < route.methods.length; j++) {
                                  ...
                                  for (
                                    let k = 0;
                                    k < method.responses.length;
                                    k++
                                  ) {
                                    let response = method.responses[k];
                                    response.selectors = this.test(
                                      response.selectors
                                    );
                              ...
                              for (
                                let i = 0;
                                i < openScraper.program.operations.length;
                                i++
                              ) {
                                let operation = {
                                  ...openScraper.program.operations[i],
                                };
                                operation.parameters = this.test(
                              ...
                              let defaultHeaders = this.test([
                                ...openScraper.mainInfo.defaultHeaders,
                              ]);
                              Object.keys(defaultHeaders).map(
                                (k) =>
                                  (defaultHeaders[k] = defaultHeaders[k].value)
                              );

                              var spec = {
                                name: openScraper.mainInfo?.name,
                                defaultHeaders: defaultHeaders,
                                servers: openScraper.mainInfo.hosts?.map(
                                  ({ id, ...item }) => item
                                ),
                                      ...
                                      responses: {
                                        "200": {
                                          ...
                                          selectors: {
                                            ...
                                            title: {
                                              selector:
                                                "#content > div.subtitles.byFilm > div.content.clearfix > table > tbody > tr:nth-child(2) > td.a1 > a > span:nth-child(2)",
                                              selectorType: "querySelector",
                                              type: "text",
                                            },
                                            year: {
                                              selector:
                                                "<strong>\\s*Year:\\s*</strong>\\s*(?<year>\\d+)\\s*</li>",
                                              selectorType: "regex",
                                              type: "text",
                                              regexGroup: "year",
                                            },
                                            imageUrl: {
                                              selector:
                                                "#content > div.subtitles.byFilm > div.box.clearfix > div.top.left > a > div > img",
                                              selectorType: "querySelector",
                                              type: "image",
                                            },
                                            subtitles: {
                                              selector:
                                                "#content > div.subtitles.byFilm > div.content.clearfix > table > tbody > tr",
                                              selectorType: "querySelector",
                                              type: "object",
                                              selectors: {
                                                id: {
                                                  selector:
                                                    '/subtitles/(?<filmId>.*?)/(?<language>.*?)/(?<subtitleId>\\d+?)"',
                                                  selectorType: "regex",
                                                  regexGroup: "subtitleId",
                                                },
                                                language: {
                                                  selector:
                                                    "td.a1 > a > span:nth-child(1)",
                                                  selectorType: "querySelector",
                                                  type: "text",
                                                },
                                                "vote-value": {
                                    ...
                                    get: {
                                      ...
                                      parameters: [
                                        ...
                                        },
                                        {
                                          ...
                                          in: "path",
                                          description:
                                            "Language of subtitle to return",
                                          required: true,
                                          type: "string",
                                        },
                                        {
